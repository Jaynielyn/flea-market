...
<div class="profile__page">
    <form class="profile__form" action="{{ route('profile') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="profile__items form__item form__images">
            @if($is_image)
        ...
        <div class="profile__items form__item">
        ...
        <div class="profile__items form__btn">
            <button class="profile__input input__btn" type="submit">更新する</button>
        </div>
    </form>
</div>
@endsection